...
public class LocalConfigurationTest {
  ...
  private LocalConfiguration locsr, lochr;
  ...
  public void setUp() throws Exception {
    ...
    lochr = new LocalConfiguration(srHR.getShortCodeWithCountryAndVariant());
  }

  @Test
  public void getConfigFileList() {
    System.out.println( locsr.getConfigFilesList() );
    System.out.println( lochr.getConfigFilesList() );
  }
}